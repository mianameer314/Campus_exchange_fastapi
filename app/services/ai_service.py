...
class AIService:
    ...
    async def _make_ml_request(self, endpoint: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        """Make request to Awais's ML service"""
    ...
    async def suggest_price(self, title: str, description: str, category: str, condition: str) -> Dict[str, Any]:
        """Suggest price using Awais's ML model"""
    ...
    async def check_duplicate(self, title: str, description: str, existing_listings: List[Dict]) -> Dict[str, Any]:
        """Check duplicates using Awais's ML model"""
        ...
        payload = {
            "title": title,
            "description": description,
            "existing_listings": existing_listings[:10]  # Limit for performance
        }
    ...
    async def recommend_listings(self, user_preferences: Dict, available_listings: List[Dict]) -> Dict[str, Any]:
        """Get recommendations using Awais's ML model"""
        ...
        payload = {
            ...
            "available_listings": available_listings[:20]  # Limit for performance
        }
